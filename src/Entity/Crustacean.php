...
#[ORM\Entity(repositoryClass: CrustaceanRepository::class)]
#[UniqueEntity(fields: ['name'], message: 'Ce crustacé existe déjà dans le glossaire.')]
#[Vich\Uploadable()]
class Crustacean
{
    #[ORM\Id]
    ...
    #[Vich\UploadableField(mapping: 'crustaceans', fileNameProperty: 'thumbnail')]
    #[Assert\Image(
        maxSize: '2M',
