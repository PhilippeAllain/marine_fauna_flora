...
#[ORM\Entity(repositoryClass: EchinodermRepository::class)]
#[UniqueEntity(fields: ['name'], message: 'Cet echinoderme existe déjà dans le glossaire.')]
#[Vich\Uploadable()]
class Echinoderm  
{
    #[ORM\Id]
    ...
    #[Vich\UploadableField(mapping: 'echinoderms', fileNameProperty: 'thumbnail')]
    #[Assert\Image(
        maxSize: '2M',
