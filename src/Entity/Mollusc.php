...
#[ORM\Entity(repositoryClass: MolluscRepository::class)]
#[UniqueEntity(fields: ['name'], message: 'Ce mollusque existe déjà dans le glossaire.')]
#[Vich\Uploadable()]
class Mollusc  
{
    #[ORM\Id]
    ...
    #[Vich\UploadableField(mapping: 'molluscs', fileNameProperty: 'thumbnail')]
    #[Assert\Image(
        maxSize: '2M',
