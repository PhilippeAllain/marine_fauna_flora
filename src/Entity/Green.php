...
#[ORM\Entity(repositoryClass: GreenRepository::class)]
#[UniqueEntity(fields: ['name'], message: 'Cette algue existe déjà dans le glossaire.')]
#[Vich\Uploadable()]
class Green  
{
    #[ORM\Id]
    ...
    #[Vich\UploadableField(mapping: 'greens', fileNameProperty: 'thumbnail')]
    #[Assert\Image(
        maxSize: '2M',
