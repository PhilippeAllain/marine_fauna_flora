...
#[ORM\Entity(repositoryClass: CnidarianRepository::class)]
#[UniqueEntity(fields: ['name'], message: 'Ce cnidaire existe déjà dans le glossaire.')]
#[Vich\Uploadable()]
class Cnidarian
{
    #[ORM\Id]
    ...
    #[Vich\UploadableField(mapping: 'cnidarians', fileNameProperty: 'thumbnail')]
    #[Assert\Image(
        maxSize: '2M',
