...
#[ORM\Entity(repositoryClass: BryozoanRepository::class)]
#[UniqueEntity(fields: ['name'], message: 'Ce bryozoan existe déjà dans le glossaire.')]
#[Vich\Uploadable()]
class Bryozoan  
{
    #[ORM\Id]
    ...
    #[Vich\UploadableField(mapping: 'bryozoans', fileNameProperty: 'thumbnail')]
    #[Assert\Image(
        maxSize: '2M',
