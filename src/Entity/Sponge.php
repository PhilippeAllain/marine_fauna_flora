...
#[ORM\Entity(repositoryClass: SpongeRepository::class)]
#[UniqueEntity(fields: ['name'], message: 'Cette éponge existe déjà dans le glossaire.')]
#[Vich\Uploadable()]
class Sponge  
{
    #[ORM\Id]
    ...
    #[Vich\UploadableField(mapping: 'sponges', fileNameProperty: 'thumbnail')]
    #[Assert\Image(
        maxSize: '2M',
