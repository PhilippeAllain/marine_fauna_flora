...
#[ORM\Entity(repositoryClass: TunicateRepository::class)]
#[UniqueEntity(fields: ['name'], message: 'Ce tunicier existe déjà dans le glossaire.')]
#[Vich\Uploadable()]
class Tunicate  
{
    #[ORM\Id]
    ...
    #[Vich\UploadableField(mapping: 'birds', fileNameProperty: 'thumbnail')]
    #[Assert\Image(
        maxSize: '2M',
